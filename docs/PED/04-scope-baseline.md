...
| SCOPE-D-03 | SMS / push notification channel | M4 or post-project | Breaches CN-03 while a paid gateway is required. Retained on the register so the unmet SH-04 expectation stays visible (CF-03). |
